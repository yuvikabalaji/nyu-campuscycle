    ...
    <div className="px-3 py-4 sm:px-4 lg:px-6">
      <div className="mb-4 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-800 hover:bg-gray-50 focus:ring-2 focus:ring-nyu-purple dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 lg:hidden"
